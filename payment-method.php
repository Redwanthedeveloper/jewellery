...
<div class="panel panel-default checkout-step-01">
	...
	<div id="collapseOne" class="panel-collapse collapse in">
	    ...
	    <form name="payment" method="post">
	     <input type="radio" checked="checked" name="paymethod" value="Debit / Credit card"> Debit / Credit card <br> <input type="radio" name="paymethod" value="COD" > COD <br>
    ...
    <input type="number" class="form-control" id="cardnumber" placeholder="Card number here" >
  </div>
	...
	<div class="col-md-4">
	<div class="mb-3">
    <label for="date" class="form-label">CVV</label>
